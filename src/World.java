 ...
 * public World
 *
 * This class defines the world, the main top-level object for this course
 * It is also used for communication between the interface and its child objects
 * It is equipped with several search functions and is able to pass data and trees to the interface
 * It is responsible for creating all child elements and assigning them to the correct parent
 */
...
public class World extends BaseObject {
    ...
    // Members
    // Note the handle to the Main Interface passed for communication purposes
    ...
    public void processFile(File f) {
        /**
         * Using a switch loop based off the first word in each line
         * seems to be the most efficient method of creating objects.
         *
         * However, it assumes that the parent of each object before it
         * is already created, meaning if the file were to be generated
         * in a different manner (as in, generate ships before docks or ports),
         * a lot of different errors could likely occur.
         *
         * Theoretically, because of the data file's design, this issue will never
         * occur. However, it may be beneficial to force everything in to a dictionary
         * after being initialized, then, once the file is complete, assign everything to
         * its proper parent.
         */
    ...
    public void startJobs() {
        // Pass down notification that jobs have begun
        for(Map.Entry<Integer, Port> portEntry: ports.entrySet()) {
